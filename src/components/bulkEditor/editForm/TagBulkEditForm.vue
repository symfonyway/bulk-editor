<template>
    <b-row>
        <b-col cols="12" xl="8" class="d-flex my-2">
            <b-form-select v-model="actionType" class="me-2 form-input-lg action-selector" plain>
        ...
        <b-col>
            <b-button variant="dark" class="border-white"  @click="onApply" :disabled="isApplyDisabled">
